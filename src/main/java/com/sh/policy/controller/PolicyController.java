...
public class PolicyController {
	...
	public ResponseEntity<String> addPolicies(@RequestBody PremiaPolicies premiaPolicy) throws FileNotFoundException {
		 ...
		 policyDetailsRepository.save(policy1); }
	...
	@RequestMapping(value = "/update/{polSysId}", method = RequestMethod.PUT)
	public PolicyDetails update(@PathVariable String polSysId) {  
		policyDetails = policyDetailsRepository.findOne(polSysId); 
		policyDetails.setCity("Madurai");
